  ...
  return (
    <section className="bg-gradient-to-b from-orange-50 to-white py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <h3 className="mt-24 mb-10 text-center text-3xl font-bold text-orange-700">
          👥 Executive Committee
        </h3>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          {executives.map((person) => (
            ...
            <div
              key={person.id}
              className="rounded-3xl bg-white p-6 text-center shadow-xl transition duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
