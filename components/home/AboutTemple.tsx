...
export default function AboutTemple() {
  return (
    <FadeInSection>
      <section className="bg-gradient-to-b from-orange-50 to-white py-20 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-6">
          ...
          >
            ...
            <h2 className="mt-6 text-3xl font-extrabold leading-tight text-gray-900 md:text-6xl">
          ...
          <div className="mt-16 grid gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-6 text-lg leading-9 text-gray-700">
                ...
                <strong> Lankapati Ravana</strong>, revered in local tradition
                as a great devotee of Lord Shiva and a scholar of the Vedas.
              </p>
              ...
              <p className="mt-6 text-lg leading-9 text-gray-700">
                For generations, devotees have visited this sacred temple
                seeking the blessings of Maa Mansa Devi for peace, prosperity,
                health and fulfillment of heartfelt prayers.
              </p>

              <div className="mt-10">
                <Link
                  href="/about"
                  className="inline-flex items-center rounded-full bg-orange-600 px-8 py-4 font-bold text-white transition duration-300 hover:scale-105 hover:bg-orange-700"
                >
            ...
            >
              ...
              <div className="rounded-3xl border border-orange-200 bg-white p-8 shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
                <div className="text-5xl">🛕</div>

                <h3 className="mt-5 text-2xl font-bold text-orange-800">
                  Sacred Temple
                </h3>

                <p className="mt-4 text-lg leading-8 text-gray-700">
                  A revered place of worship where devotees gather with faith
                  and devotion to seek Maa Mansa Devi's blessings.
                </p>
              </div>
